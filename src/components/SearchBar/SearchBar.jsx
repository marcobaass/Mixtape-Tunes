...
export default function SearchBar({text, setText, onSubmit, handleSuggestions, suggestions, onBlur, inputRef, dropdownRef}) {
  ...
  return (
    <div className="relative">
      <form onSubmit={onSubmit} onBlur={(e) => onBlur(e, dropdownRef)} className={`${styles.gridSearch} flex items-center space-x-2 p-2 ml-3 mr-3 bg-bright-cyan rounded-full shadow-md max-w-md grow`}>
        <input
          type="text"
          id="text"
          name="text"
